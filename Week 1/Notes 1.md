...
|-------------------------------|-------------------------|-------------|
| Modus Ponens                  | <span style="margin-left: 40px;"> $`  \begin{array}{c} \alpha \rightarrow \beta \\ \alpha \\ \hline \beta \end{array} `$ </span> | If "A implies B" is true and A is true, then B must also be true. |
